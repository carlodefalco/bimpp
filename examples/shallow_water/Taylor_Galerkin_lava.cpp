...
*/
  ...
  const auto diff_term_h_x  = h_cell>epsilon ? grad_cell_h[0]*vel_rusanov_cell_y*.5 : grad_cell_h[0]*vel_rusanov_cell_y*.5;
  const auto diff_term_h_y  = h_cell>epsilon ? grad_cell_h[1]*vel_rusanov_cell_x*.5 : grad_cell_h[1]*vel_rusanov_cell_x*.5;
