...
main (int argc, char **argv)
{
  ...
  tmsh.vtk_export ("p4est_dr_test_5_marker");
  ...
  for (int adapt = 0; adapt < refine_steps; ++adapt)
    {
      ...
      tmsh.octbin_export ((std::string("p4est_dr_test_5_marker_u_")
      ...
      tmsh.octbin_export ((std::string("p4est_dr_test_5_marker_uex_")
      ...
      tmsh.octbin_export ((std::string("p4est_dr_test_5_marker_du0_x_")
                           + std::to_string(adapt)).c_str(), du0.first);
      tmsh.octbin_export ((std::string("p4est_dr_test_5_marker_du0_y_")
                           + std::to_string(adapt)).c_str(), du0.second);
      
      tmsh.octbin_export ((std::string("p4est_dr_test_5_marker_du1_x_")
                           + std::to_string(adapt)).c_str(), du1.first);
      tmsh.octbin_export ((std::string("p4est_dr_test_5_marker_du1_y_")
                           + std::to_string(adapt)).c_str(), du1.second);
      
      auto refine_fun = [& delta1, & du0, & du1, & global_rhs, & tmsh, R] (tmesh::quadrant_iterator q)
        {
      ...
      tmsh.vtk_export ((std::string("p4est_dr_test_5_marker_newmesh_")
