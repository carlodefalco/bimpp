...
main (int argc, char **argv)
{
  ...
  tmsh.vtk_export ("p4est_dr_test_1_marker");
  ...
  for (int adapt = 0; adapt < refine_steps; ++adapt)
    {
      ...
      tmsh.octbin_export ((std::string("p4est_dr_test_1_marker_u_")
      ...
      tmsh.octbin_export ((std::string("p4est_dr_test_1_marker_du_y_")
      ...
      tmsh.vtk_export ((std::string("p4est_dr_test_1_marker_newmesh_")
