...
main (int argc, char **argv)
{
  ...
  // Buffer for saving and psilon*epsilon
  char filename[255]="";
  double eps2=EPS*EPS;
      ...
      for (int ii = 0; ii < 4; ++ii)
        {
          if (! quadrant->is_hanging (ii)){
            ...
            uold[ord0(quadrant->gt (ii))] = std::sin(10*xx*yy);
          }
          ...
          else
            {
              ...
              uold[ord0(quadrant->gparent(0,ii))] +=0.;
              uold[ord0(quadrant->gparent(1,ii))] +=0.;
            }
        }
    }
     ...
     TOC("Resetting")
      ...
      for (auto quadrant = tmsh.begin_quadrant_sweep ();
         ...
         ++quadrant){
           ...
           {
             if (! quadrant->is_hanging (ii)){
               reazuu[quadrant->gt (ii)] = -linc(uold[ord0(quadrant->gt (ii))]);
               fu[quadrant->gt (ii)] = linf(uold[ord0(quadrant->gt (ii))]);
               fw[quadrant->gt (ii)] = -uold[ord0(quadrant->gt (ii))];
             }
             else
             {
      ...
      bim2a_rhs (tmsh, ecoeff, fw, u, ord1);
      TOC ("assemble RHS");
