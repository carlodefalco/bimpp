...
void equation::operator()(sparse_matrix& lhs, std::vector<double>& rhs, const std::vector<double>& u)
{
	lhs.resize(1);
	lhs[0][0]=2;
	rhs.resize(1);
...
void equation::operator()(std::vector<double>& f, const std::vector<double>& u)
{
	f.resize(1);
	f[0]=u[0]*u[0]-2.0;
}
