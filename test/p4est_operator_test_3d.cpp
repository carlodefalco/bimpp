...
{
  std::vector<double> p = {0.00, 0.00, 0.00, 0.00,
                           0.25, 0.25, 0.25, 0.25,
                           0.75, 0.75, 0.75, 0.75,
                           1.00, 1.00, 1.00, 1.00,
                           0.00, 0.00, 0.00, 0.00,
  ...
  std::vector<int> t = { 1,  5,  2,  6, 17, 21, 18, 22,  1,
  ...
  Array<int> oct_t (dim_vector (9, t.size() / 9), 0);
...
main (int argc, char **argv)
{
  ...
  if (rank == 0)
    write_example_connectivity3 ("p4est_operator_test_3d.octbin.gz");
