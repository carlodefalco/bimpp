...
main (int argc, char **argv)
{
  ...
  tmsh.octbin_export ("p4est_estimator_test_1", global_rhs);
  ...
  tmsh.octbin_export ("p4est_estimator_test_1_du_x", du.first);
  tmsh.octbin_export ("p4est_estimator_test_1_du_y", du.second);
