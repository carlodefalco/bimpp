...
int main (int argc, char **argv)
{
  ...
  if (rank == 0)
    {
      std::cout << "\n\n*****\ntest 2: Advection-Diffusion"
                << " with full diffusion tensor\n*****\n";
      ...
      std::vector<double> acoeff (msh.nelements * 9, 0.0);
      ...
      std::cout << "make advection-diffusion with anisotropic diffusion"
                << std::endl;
