...
int unit_square(const char * filename)
{
...
static int uniform_refinement(tmesh::quadrant_iterator quadrant)
{
    return 1;
}

static int segment_list_refinement(tmesh::quadrant_iterator quadrant, const std::vector<Segment> & segment_list)
{
    double x0 = quadrant->p(0, 0); double y0 = quadrant->p(1, 0);
    double x1 = quadrant->p(0, 1); double y1 = quadrant->p(1, 2);
